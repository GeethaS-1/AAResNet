...
###########
p = Augmentor.Pipeline("D:/Geetha/Kvasir/augument/Kvasir_trainimages/")

# Specify a directory containing the ground truth or mask images:
p.ground_truth("D:/Geetha/Kvasir/augument/Kvasir_trainmasks/")
...
callbacks = [
          ModelCheckpoint("E:/Geetha/Revision_1/Kvasir/analysis70_30/resatten_unet_model_20-6_augKvasir_earlystop.h5", save_best_only=True,verbose=1),
#          ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=4),
          CSVLogger("E:/Geetha/Revision_1/Kvasir/analysis70_30/resatten_unet_model_20-6_augKvasir_earlystop.csv"),
          TensorBoard(),
          EarlyStopping(monitor='val_loss', mode='min', verbose=1, patience=50)
]

start3 = datetime.now() 
att_res_unet_history_kvasir = att_res_unet_model.fit(X_train, y_train, 
                    verbose=1,
...
file = open('E:/Geetha/Revision_1/Kvasir/analysis70_30/dump.txt', 'wb')
pickle.dump(execution_time_AttResUnet, file)
file.close()

file = open('E:/Geetha/Revision_1/Kvasir/analysis70_30/dump.txt', 'rb')
