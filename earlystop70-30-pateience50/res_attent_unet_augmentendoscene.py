...
callbacks = [
          ModelCheckpoint("E:/Geetha/Revision_1/Endoscene/analysis70_30/resatten_unet_model_21-6_augEndoscene_earlystop.h5", save_best_only=True,verbose=1),
#          ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=4),
          CSVLogger("E:/Geetha/Revision_1/Endoscene/analysis70_30/resatten_unet_model_21-6_augEndoscene_earlystop.csv"),
          TensorBoard(),
         EarlyStopping(monitor='val_loss', mode='min', verbose=1, patience=50)
]

start3 = datetime.now() 
att_res_unet_history_endoscene = att_res_unet_model.fit(X_train, y_train, 
                    verbose=1,
