...
#              metrics=['accuracy', dice_coef, jacard_coef,precission,recall])
    callbacks = [
          ModelCheckpoint("E:/Geetha/Revision_1/CVC/kfoldanalysis/res_attent_unet_CVCClinic_5fold%s.h5"%(str(fold)), save_best_only=True),
          #ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=4),
          CSVLogger("E:/Geetha/Revision_1/CVC/kfoldanalysis/res_attent_unet_CVCClinic_5fold_100epochs%s.csv"%(str(fold))),
          TensorBoard(),
...
#[0.00194298 0.00086408 0.01366211 0.02410566 0.01852397 0.00812576]
#[0.00206736 0.98906245 0.94779606 0.90186661 0.90643063 0.9941533 ]
##*************************************************************
...
#Results obtained on 26-6-22 for 3 folds
#print (cvscores)
