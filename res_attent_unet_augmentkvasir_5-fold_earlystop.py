...
#              metrics=['accuracy', dice_coef, jacard_coef,precission,recall])
    callbacks = [
          ModelCheckpoint("E:/Geetha/Revision_1/Kvasir/kfoldanalysis/res_attent_unet_kvasir_5fold%s.h5"%(str(fold)), save_best_only=True),
          #ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=4),
          CSVLogger("E:/Geetha/Revision_1/Kvasir/kfoldanalysis/res_attent_unet_kvasir_5fold_100epochs%s.csv"%(str(fold))),
          TensorBoard(),
...
#Results obtained after 5 folds on 7-7-22
#Mean score with std deviation over 5 folds
#[0.01261492 0.0051915  0.02479236 0.04261364 0.02248394 0.02702399]
#[0.00932691 0.97259679 0.9418077  0.89126332 0.90555356 0.98148198]
